...
function generateReduxStore({ options }) {
  ...
  generateFile({
    filePath: path.resolve(options.outputPath, 'generated/store.js'),
...
function generateHelperFile(outputPath) {
  shell.cp(
    path.resolve(__dirname, 'templates/generated/helper.js'),
    path.resolve(outputPath, 'generated/helper.js')
  );
}
...
module.exports = function processAfterAllFormattedSnippets({ components, options }) {
  ...
  // helpers
  generateHelperFile(options.outputPath);
